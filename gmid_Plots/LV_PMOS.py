...
path = r"C:\Users\NITHIN P\Downloads\gmid_IHP130\gmid Data\LV_PMOS\\" # Please provide your path file
...
for i in range(13):
    filename = filename = path + f"gmid_pmos_{i + 1:02d}_sg13_lv_pmos_tb.txt"
    try:
...
#     fig.suptitle("LV-PMOS-1.65V gm/id plots", fontsize=16, fontweight='bold')  # Title added
#     plot_data = [
#         (vgs, gm_id, 'Vgs', 'gm/id'),
#         (Vov, gm_id, 'Vov', 'gm/id'),
